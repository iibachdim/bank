...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="{{ route('exportExcel.nasabahAll') }}" class="btn btn-success">Export Excel</a>
        </div>


        <!-- /.box-header -->
        <div class="box-body">
            <table id="nasabah-table" class="table table-striped">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Name</th>
    ...
    @include('admin.nasabah.form_import')
