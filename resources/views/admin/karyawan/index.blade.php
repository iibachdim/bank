...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="{{ route('exportExcel.karyawanAll') }}" class="btn btn-success">Export Excel</a>
        </div>
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('karyawans') }}";
                    else url = "{{ url('karyawans') . '/' }}" + id;
